...
export default function AddEditRecipeScreen({ route, navigation }) {
  ...
  const save = () => {
    ...
    if (!instructions.trim()) {
      Alert.alert('Missing instructions', 'Add the steps to prepare this recipe.');
      return;
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TouchableOpacity style={styles.imgBtn} onPress={pickImage} activeOpacity={0.8}>
          {image ? (
            ...
            <View style={styles.imgPlaceholder}>
              ...
              <Text style={{ color: '#bbb', marginTop: 10, fontSize: 15 }}>Tap to add a photo</Text>
              <Text style={{ color: '#ccc', fontSize: 12, marginTop: 4 }}>From your photo library</Text>
            </View>
          )}
        </TouchableOpacity>
        ...
        <TextInput
          style={[styles.input, { minHeight: 130, lineHeight: 22 }]}
          value={ingredients}
        ...
        <TextInput
          style={[styles.input, { minHeight: 175 }]}
          value={instructions}
